...
For this course, all fundamental main math course objects and theorems about them (with solution proof) will be added, so the course will change. 
...
The two compulsory subjects are Logic and Set Theory:
    ...
    - The second subject Set Theory stars by ZFC set theory axioms.
